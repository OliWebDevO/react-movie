...
export const updateSearchCount = async (searchTerm, movie) => {
    ...
    try {
        ...
        // If the search term is already in the database, update the count
        if (result.documents.length > 0) {
            ...
            // If the search term is not in the database, create a new document with the search term and count as 1
